				...
				<!-- 主体start -->	
					<dl class="account-basic clearfix">
						<dt class="pull-left">
							<p class="account-head">
								<img src="${basePath}/resources/bk/img/noavatar_middle.gif">
							</p>
						</dt>
						<dd class="pull-left margin-large-left margin-small-top">
							...
							<p class="text-small">
								...
								<!-- <a class="margin-left text-main text-underline" href="javascript:void(0)">立即认证</a> -->
							</p>
							<p class="text-small">
								<span class="show pull-left base-name">注册时间</span>:<span
					...
					<div class="account-basic clearfix">
						...
						<div class="progress-bar pull-left margin-large-left margin-large-35">
							<div style="background: rgb(255, 153, 0) none repeat scroll 0% 0%; width: 180px;" data-width="100"></div>
						</div>
						<span class="pull-left show text-small">
							安全级别: <span style="color: rgb(255, 153, 0);" class="leval-safe">高</span>
						</span>
					</div>
					<ul class="accound-bund">
						<li class="clearfix"><span class="bund-class">登录密码</span> <span
							...
							<span class="pull-right margin-large-right"> <i
								...
								class="margin-right text-green-deep">已设置</em> | <a href="javascript:void(0)"
						...
						<li class="clearfix"><span class="bund-class">邮箱绑定</span> <span
							...
							class="pull-right margin-large-right"> <i
								class="glyphicon glyphicon-ok-circle pull-left"></i> <em
								class="margin-right text-green-deep">已设置</em> | <a href="javascript:void(0)"
						...
						<li class="clearfix border-bottom-none"><span
							class="bund-class">邀请链接</span> <span class="w45" id="fe_text">http://www.mycodes.net</span>
							<span class="pull-right margin-large-right"> <a
								class="button-word1 margin-left" id="copy_button"
								data-clipboard-target="fe_text" href="javascript:void(0)">复制链接</a>
						</span></li>
					</ul>
