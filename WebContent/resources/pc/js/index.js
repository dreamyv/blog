...
//	 },100);
	...
	/*点击提交留言按钮*/
	$(".box.box4 .msg .btn .btn_sbu").click(function(){
		alert(1)
	});
})();
...
function myDemo(){
	...
	/*鼠标按下*/
	document.getElementById("box_case").onmousedown = function(e){
		e = e || window.event;
		clearInterval(timer);
		/*顶部文字、导航栏隐藏*/
...
var fail =true;
function init(){
	player.add(basePath+"/resources/pc/mp3/03.mp3");
	player.init({
			volume : 5,
...
var arr1 = [basePath+"/resources/pc/mp3/01.mp3"];
var arr2 = [basePath+"/resources/pc/mp3/02.mp3"];
var arr3 = [basePath+"/resources/pc/mp3/03.mp3"];
var arr4 = [basePath+"/resources/pc/mp3/04.mp3"];
