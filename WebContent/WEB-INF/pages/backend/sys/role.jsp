                            ...
                            <form  id="form_user" action="#" class="form-horizontal form-label-left" method="POST" novalidate>
                                <div class="row">
                                    <div class="item form-group">
                                        ...
                                        <span class="required">*</span>角色名称</label>
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                        	<input type="hidden" value="" id="id" name="id" maxlength="12"/>
                                            <input type="text" value="" id="roleName" name="roleName" maxlength="12" required="required"  class="form-control " maxlength="11" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            <input type="text" value=""  id="roleDesc" name="roleDesc" maxlength="12" required="required"  class="form-control "  />
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="${basePath}/resources/bk/js/sys/role.js"></script>
